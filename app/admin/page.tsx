      ...
      <div className="vs-root vs-fade-item" style={{ width: '100%', maxWidth: 400, padding: '0 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <div style={{
            ...
            border: '1px solid #D9C9AA', background: '#0d0b09',
        ...
        <div style={{
          ...
          border: `1px solid ${online === null ? '#D9C9AA' : online ? 'rgba(46,158,91,0.3)' : 'rgba(226,84,63,0.3)'}`,
        }}>
          <div className={online ? 'vs-live-dot' : ''} style={{
            width: 8, height: 8, borderRadius: '50%',
            background: online === null ? '#5B4D42' : online ? '#2E9E5B' : '#E2543F',
          }} />
          <span style={{ fontSize: 13, color: online === null ? '#5B4D42' : online ? '#227A46' : '#C43F2C' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', fontSize: 11, letterSpacing: '0.15em', color: '#5B4D42', textTransform: 'uppercase', marginBottom: 6 }}>
              Usuario
            </label>
            <input
              ...
              disabled={!online}
              style={{
                width: '100%', padding: '12px 14px', borderRadius: 8, border: '1px solid #D9C9AA',
          ...
          <button
            ...
            style={{
              ...
              background: online ? undefined : '#F4ECDD', color: online ? '#231A10' : '#5B4D42',
