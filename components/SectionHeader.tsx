  ...
  if (align === 'center') {
    return (
      <div className="text-center mb-16 lg:mb-20">
        ...
        >
          <span className={`hidden sm:block h-px w-8 ${ruleColor}`} />
        ...
        <motion.h2
          ...
          className={`${titleColor} text-4xl sm:text-5xl lg:text-[3.75rem] font-light leading-[1.05] tracking-[-0.02em] mx-auto max-w-3xl`}
        ...
        {subtitle && (
          <motion.p
            ...
            className={`${subColor} text-base leading-relaxed font-sans font-light max-w-xl mx-auto mt-6`}
          >
            {subtitle}
          </motion.p>
        )}
