...
const galleryImages = [
  // Sala
  { src: airbnbImg('31d2e042-c704-462e-ba37-44f49f92e819'), category: 'sala', alt: 'Living room' },
  // Cocina
  { src: airbnbImg('759db471-3461-4960-820b-c0ceeaca3e9f'), category: 'cocina', alt: 'Gourmet kitchen' },
  { src: airbnbImg('906719f3-4034-44a7-ad1c-72d1a8710167'), category: 'cocina', alt: 'Kitchen' },
  { src: airbnbImg('dcf3f7fb-d4c7-44ed-be38-92f7599d862f'), category: 'cocina', alt: 'Kitchen' },
  { src: airbnbImg('dbceb58b-1065-447c-8a00-d1ff0d57eca4'), category: 'cocina', alt: 'Poolside kitchenette and bar' },
  // Comedor
  { src: airbnbImg('5f36da75-fc2c-4c27-88e6-bb56ece6e320'), category: 'comedor', alt: 'Dining room' },
  { src: airbnbImg('3cbcdf61-9927-476a-9977-ea0f53999f54'), category: 'comedor', alt: 'Terrace dining' },
  // Cuartos (bedrooms)
  { src: airbnbImg('3d3de8d6-7a5d-40d6-a807-d74a7191dbf5'), category: 'cuartos', alt: 'Bedroom 1' },
  { src: airbnbImg('bfeccbcb-b388-494f-ab1a-6f0d67bf24c1'), category: 'cuartos', alt: 'Master suite ocean-view terrace' },
  { src: airbnbImg('86343df8-a0a3-47af-b547-c85038289c8a'), category: 'cuartos', alt: 'Bedroom 2' },
  { src: airbnbImg('d0cc8d86-b361-4314-9391-59d546c3a8a8'), category: 'cuartos', alt: 'Bedroom 3' },
  { src: airbnbImg('fdba7ace-0903-4e2c-9fe3-d4410956c29e'), category: 'cuartos', alt: 'Bedroom 4' },
  // Baños (bathrooms)
  { src: airbnbImg('fac0e2f2-f9d3-41a9-bb90-edc811546fec'), category: 'banos', alt: 'Bathroom 1' },
  { src: airbnbImg('92f16c3f-1821-4922-9d67-cc65f4e3a6ea'), category: 'banos', alt: 'Bathroom 2' },
  { src: airbnbImg('9fc7fa86-d617-4003-825a-33e927a2cc63'), category: 'banos', alt: 'Bathroom 3' },
  { src: airbnbImg('bb97cc97-7727-4428-a64e-4bb9cbf208b8'), category: 'banos', alt: 'Bathroom 4' },
  // Exterior
  ...
  { src: airbnbImg('1c342fc1-989f-4b7d-9bb2-0db53b63bbeb'), category: 'exterior', alt: 'Path down to the private beach' },
  { src: airbnbImg('c57e248d-56e4-441b-98df-8a844a939ba4'), category: 'exterior', alt: 'Private cove beach' },
  // Alberca (pool)
  { src: airbnbImg('eb5bae1a-5fc5-421a-a881-973d4559de7f'), category: 'alberca', alt: 'Infinity pool' },
  { src: airbnbImg('9070c132-eb9a-4609-853a-2da28c26a555'), category: 'alberca', alt: 'Pool' },
  { src: airbnbImg('7dffdbbb-c360-4ad1-8ef3-143c9d36c481'), category: 'alberca', alt: 'Pool' },
];
