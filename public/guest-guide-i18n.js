...
(function () {
  ...
  var DICT = {
    en: {
      ...
      card_pet_t: 'Pet Friendly',
      card_pet_b:
        'Pets welcome with prior authorization. A refundable deposit of $400 USD is required at check-in.',
      instructivo_badge: 'Complete Guide · Full Guide',
      instructivo_title: 'Villa Instructions',
      instructivo_desc: 'Here you\'ll find <strong>all the detailed information about the villa</strong> — how to use appliances, pool rules, kitchen, house rules, emergency contacts and much more. Available in Spanish and English.',
      instructivo_btn1_label: 'Spanish Version',
      instructivo_btn1_sub: 'Complete villa guide',
      instructivo_btn2_label: 'English Version',
      instructivo_btn2_sub: 'Complete villa guide',
    ...
    es: {
      ...
      card_pet_t: 'Pet Friendly',
      card_pet_b:
        'Mascotas bienvenidas con autorización previa. Se requiere un depósito reembolsable de $400 USD al momento del check-in.',
      instructivo_badge: 'Guía Completa · Full Guide',
      instructivo_title: 'Instrucciones de la Villa',
      instructivo_desc: 'Aquí encontrarás <strong>toda la información detallada de la casa</strong> — cómo usar los electrodomésticos, reglas de la alberca, cocina, normas de la casa, contactos de emergencia y mucho más. Disponible en español e inglés.',
      instructivo_btn1_label: 'Versión en Español',
      instructivo_btn1_sub: 'Guía completa de la villa',
      instructivo_btn2_label: 'English Version',
      instructivo_btn2_sub: 'Complete villa guide',
